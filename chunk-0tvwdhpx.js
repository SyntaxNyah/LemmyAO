import{la as uk,ma as lk,na as ck,oa as pk,pa as gk}from"./chunk-rrw8hbm7.js";import{_a as jk}from"./chunk-ps5tjgy2.js";import{Oc as k}from"./chunk-cf2anp2z.js";import"./chunk-9cv6hrcp.js";var v="decalFragmentDeclaration",R=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;if(!k.IncludesShadersStore[v])k.IncludesShadersStore[v]=R;var L={name:v,shader:R};var z="defaultFragmentDeclaration",U=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;if(!k.IncludesShadersStore[z])k.IncludesShadersStore[z]=U;var F={name:z,shader:U};var A="objectIdFunctions",j=`highp vec4 encodeObjectId(highp float objectId) {
...
`;if(!k.IncludesShadersStore[A])k.IncludesShadersStore[A]=j;var u={name:A,shader:j};var B="prePassDeclaration",l=`#ifdef PREPASS
...
#endif
#endif
`;if(!k.IncludesShadersStore[B])k.IncludesShadersStore[B]=l;var c={name:B,shader:l};var C="oitDeclaration",p=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;if(!k.IncludesShadersStore[C])k.IncludesShadersStore[C]=p;var g={name:C,shader:p};var G="lightFragmentDeclaration",i=`#ifdef LIGHT{X}
...
#endif
#endif
`;if(!k.IncludesShadersStore[G])k.IncludesShadersStore[G]=i;var S={name:G,shader:i};var J="lightUboDeclaration",m=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;if(!k.IncludesShadersStore[K])k.IncludesShadersStore[K]=d;var o={name:K,shader:d};var N="clusteredLightingFunctions",t=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;if(!k.IncludesShadersStore[N])k.IncludesShadersStore[N]=t;var s={name:N,shader:t};var O="lightsFragmentFunctions",n=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;if(!k.IncludesShadersStore[O])k.IncludesShadersStore[O]=n;var r={name:O,shader:n};var Q="shadowsFragmentFunctions",a=`#ifdef SHADOWS
...
#endif
#endif
`;if(!k.IncludesShadersStore[Q])k.IncludesShadersStore[Q]=a;var e={name:Q,shader:a};var T="samplerFragmentDeclaration",kk=`#ifdef _DEFINENAME_
...
#endif
`;if(!k.IncludesShadersStore[T])k.IncludesShadersStore[T]=kk;var qk={name:T,shader:kk};var W="fresnelFunction",vk=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;if(!k.IncludesShadersStore[W])k.IncludesShadersStore[W]=vk;var zk={name:W,shader:vk};var X="reflectionFunction",Ak=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;if(!k.IncludesShadersStore[X])k.IncludesShadersStore[X]=Ak;var Bk={name:X,shader:Ak};var Y="imageProcessingDeclaration",Ck=`#ifdef EXPOSURE
...
#endif
`;if(!k.IncludesShadersStore[Y])k.IncludesShadersStore[Y]=Ck;var Gk={name:Y,shader:Ck};var Z="imageProcessingFunctions",Jk=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;if(!k.IncludesShadersStore[Z])k.IncludesShadersStore[Z]=Jk;var Kk={name:Z,shader:Jk};var _="textureRepetitionFunctions",Nk=`#if TEXTURE_REPETITION_MODE>0
...
`;if(!k.IncludesShadersStore[_])k.IncludesShadersStore[_]=Nk;var Ok={name:_,shader:Nk};var $="bumpFragmentMainFunctions",Qk=`#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
#endif
`;if(!k.IncludesShadersStore[$])k.IncludesShadersStore[$]=Qk;var Tk={name:$,shader:Qk};var y="bumpFragmentFunctions",Wk=`#if defined(BUMP)
...
#endif
`;if(!k.IncludesShadersStore[y])k.IncludesShadersStore[y]=Wk;var Xk={name:y,shader:Wk};var w="clipPlaneFragmentDeclaration",Yk=`#ifdef CLIPPLANE
...
#endif
`;if(!k.IncludesShadersStore[w])k.IncludesShadersStore[w]=Yk;var Zk={name:w,shader:Yk};var x="fogFragmentDeclaration",_k=`#ifdef FOG
...
#endif
`;if(!k.IncludesShadersStore[x])k.IncludesShadersStore[x]=_k;var $k={name:x,shader:_k};var V="clipPlaneFragment",yk=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;if(!k.IncludesShadersStore[V])k.IncludesShadersStore[V]=yk;var wk={name:V,shader:yk};var H="bumpFragment",xk=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;if(!k.IncludesShadersStore[H])k.IncludesShadersStore[H]=xk;var Vk={name:H,shader:xk};var I="decalFragment",Hk=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;if(!k.IncludesShadersStore[I])k.IncludesShadersStore[I]=Hk;var Ik={name:I,shader:Hk};var f="depthPrePass",fk=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;if(!k.IncludesShadersStore[f])k.IncludesShadersStore[f]=fk;var bk={name:f,shader:fk};var b="lightFragment",Pk=`#ifdef LIGHT{X}
...
#endif
#endif
`;if(!k.IncludesShadersStore[b])k.IncludesShadersStore[b]=Pk;var Ek={name:b,shader:Pk};var P="logDepthFragment",Dk=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;if(!k.IncludesShadersStore[P])k.IncludesShadersStore[P]=Dk;var Mk={name:P,shader:Dk};var E="fogFragment",Rk=`#ifdef FOG
...
#endif
`;if(!k.IncludesShadersStore[E])k.IncludesShadersStore[E]=Rk;var Lk={name:E,shader:Rk};var D="oitFragment",Uk=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;if(!k.IncludesShadersStore[D])k.IncludesShadersStore[D]=Uk;var Fk={name:D,shader:Uk};var M="defaultPixelShader",ik=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;if(!k.ShadersStore[M])k.ShadersStore[M]=ik;var Sk=[L,F,uk,lk,ck,u,c,g,pk,jk,S,h,o,s,r,e,qk,zk,Bk,Gk,Kk,Ok,Tk,Xk,Zk,gk,$k,wk,Vk,Ik,bk,Ek,Mk,Lk,Fk];for(let q of Sk)if(!k.IncludesShadersStore[q.name])k.IncludesShadersStore[q.name]=q.shader;var Fv={name:M,shader:ik};export{Fv as defaultPixelShader};

//# debugId=82EF82B9A2DCFCA464756E2164756E21
//# sourceMappingURL=chunk-0tvwdhpx.js.map
