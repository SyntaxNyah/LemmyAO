import{$ as Lk,_ as Fk,aa as lk,ba as uk,ca as jk}from"./chunk-6v249pa2.js";import{ea as Uk}from"./chunk-d8vnnm5b.js";import{Lc as k}from"./chunk-284eakdn.js";import"./chunk-vth2vbh3.js";var v="objectIdFunctions",M=`fn encodeObjectId(objectId: f32)->vec4f {
...
`;if(!k.IncludesShadersStoreWGSL[v])k.IncludesShadersStoreWGSL[v]=M;var R={name:v,shader:M};var y="prePassDeclaration",U=`#ifdef PREPASS
...
#endif
#endif
`;if(!k.IncludesShadersStoreWGSL[y])k.IncludesShadersStoreWGSL[y]=U;var F={name:y,shader:U};var z="oitDeclaration",L=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;if(!k.IncludesShadersStoreWGSL[z])k.IncludesShadersStoreWGSL[z]=L;var l={name:z,shader:L};var A="lightUboDeclaration",u=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;if(!k.IncludesShadersStoreWGSL[A])k.IncludesShadersStoreWGSL[A]=u;var j={name:A,shader:u};var J="ltcHelperFunctions",c=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;if(!k.IncludesShadersStoreWGSL[J])k.IncludesShadersStoreWGSL[J]=c;var g={name:J,shader:c};var K="clusteredLightingFunctions",p=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;if(!k.IncludesShadersStoreWGSL[K])k.IncludesShadersStoreWGSL[K]=p;var i={name:K,shader:p};var N="clusteredLightingCompute",m=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;if(!k.IncludesShadersStoreWGSL[N])k.IncludesShadersStoreWGSL[N]=m;var S={name:N,shader:m};var Q="lightsFragmentFunctions",o=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;if(!k.IncludesShadersStoreWGSL[Q])k.IncludesShadersStoreWGSL[Q]=o;var d={name:Q,shader:o};var V="shadowsFragmentFunctions",h=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;if(!k.IncludesShadersStoreWGSL[V])k.IncludesShadersStoreWGSL[V]=h;var t={name:V,shader:h};var X="samplerFragmentDeclaration",s=`#ifdef _DEFINENAME_
...
#endif
`;if(!k.IncludesShadersStoreWGSL[X])k.IncludesShadersStoreWGSL[X]=s;var n={name:X,shader:s};var Y="fresnelFunction",r=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;if(!k.IncludesShadersStoreWGSL[Y])k.IncludesShadersStoreWGSL[Y]=r;var a={name:Y,shader:r};var Z="reflectionFunction",e=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;if(!k.IncludesShadersStoreWGSL[Z])k.IncludesShadersStoreWGSL[Z]=e;var kk={name:Z,shader:e};var _="imageProcessingDeclaration",qk=`#ifdef EXPOSURE
...
#endif
`;if(!k.IncludesShadersStoreWGSL[_])k.IncludesShadersStoreWGSL[_]=qk;var vk={name:_,shader:qk};var $="imageProcessingFunctions",yk=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;if(!k.IncludesShadersStoreWGSL[$])k.IncludesShadersStoreWGSL[$]=yk;var zk={name:$,shader:yk};var w="textureRepetitionFunctions",Ak=`#if TEXTURE_REPETITION_MODE>0
...
`;if(!k.IncludesShadersStoreWGSL[w])k.IncludesShadersStoreWGSL[w]=Ak;var Jk={name:w,shader:Ak};var x="bumpFragmentMainFunctions",Kk=`#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;if(!k.IncludesShadersStoreWGSL[x])k.IncludesShadersStoreWGSL[x]=Kk;var Nk={name:x,shader:Kk};var B="bumpFragmentFunctions",Qk=`#if defined(BUMP)
...
#endif
`;if(!k.IncludesShadersStoreWGSL[B])k.IncludesShadersStoreWGSL[B]=Qk;var Vk={name:B,shader:Qk};var G="clipPlaneFragmentDeclaration",Xk=`#ifdef CLIPPLANE
...
#endif
`;if(!k.IncludesShadersStoreWGSL[G])k.IncludesShadersStoreWGSL[G]=Xk;var Yk={name:G,shader:Xk};var O="fogFragmentDeclaration",Zk=`#ifdef FOG
...
#endif
`;if(!k.IncludesShadersStoreWGSL[O])k.IncludesShadersStoreWGSL[O]=Zk;var _k={name:O,shader:Zk};var T="clipPlaneFragment",$k=`#if defined(CLIPPLANE) || defined(CLIPPLANE2) || defined(CLIPPLANE3) || defined(CLIPPLANE4) || defined(CLIPPLANE5) || defined(CLIPPLANE6)
if (false) {}
#endif
#ifdef CLIPPLANE
...
{discard;}
#endif
`;if(!k.IncludesShadersStoreWGSL[T])k.IncludesShadersStoreWGSL[T]=$k;var wk={name:T,shader:$k};var W="bumpFragment",xk=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;if(!k.IncludesShadersStoreWGSL[W])k.IncludesShadersStoreWGSL[W]=xk;var Bk={name:W,shader:xk};var C="decalFragment",Gk=`#ifdef DECAL
...
#endif
`;if(!k.IncludesShadersStoreWGSL[C])k.IncludesShadersStoreWGSL[C]=Gk;var Ok={name:C,shader:Gk};var H="depthPrePass",Tk=`#ifdef DEPTHPREPASS
...
#endif
#endif
`;if(!k.IncludesShadersStoreWGSL[H])k.IncludesShadersStoreWGSL[H]=Tk;var Wk={name:H,shader:Tk};var I="lightFragment",Ck=`#ifdef LIGHT{X}
...
#endif
#endif
`;if(!k.IncludesShadersStoreWGSL[I])k.IncludesShadersStoreWGSL[I]=Ck;var Hk={name:I,shader:Ck};var f="logDepthFragment",Ik=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;if(!k.IncludesShadersStoreWGSL[f])k.IncludesShadersStoreWGSL[f]=Ik;var fk={name:f,shader:Ik};var b="fogFragment",bk=`#ifdef FOG
...
#endif
`;if(!k.IncludesShadersStoreWGSL[b])k.IncludesShadersStoreWGSL[b]=bk;var Pk={name:b,shader:bk};var P="meshBlendTagFragmentOutput",Dk=`#if SCENE_MRT_COUNT>{X}
...
#endif
#endif
`;if(!k.IncludesShadersStoreWGSL[P])k.IncludesShadersStoreWGSL[P]=Dk;var Ek={name:P,shader:Dk};var D="oitFragment",Mk=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;if(!k.IncludesShadersStoreWGSL[D])k.IncludesShadersStoreWGSL[D]=Mk;var Rk={name:D,shader:Mk};var E="defaultPixelShader",ck=`#include<defaultUboDeclaration>
...
`;if(!k.ShadersStoreWGSL[E])k.ShadersStoreWGSL[E]=ck;var gk=[Fk,Lk,lk,R,F,l,uk,Uk,j,g,i,S,d,t,n,a,kk,vk,zk,Jk,Nk,Vk,Yk,jk,_k,wk,Bk,Ok,Wk,Hk,fk,Pk,Ek,Rk];for(let q of gk)if(!k.IncludesShadersStoreWGSL[q.name])k.IncludesShadersStoreWGSL[q.name]=q.shader;var Dv={name:E,shader:ck};export{Dv as defaultPixelShaderWGSL};

//# debugId=C50C677DA79464E264756E2164756E21
//# sourceMappingURL=chunk-55btmert.js.map
