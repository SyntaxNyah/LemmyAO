import{$ as jq,_ as lq,aa as cq,ba as gq,ca as pq}from"./chunk-6v249pa2.js";import{ea as Lq}from"./chunk-d8vnnm5b.js";import{Lc as q}from"./chunk-284eakdn.js";import"./chunk-vth2vbh3.js";var z="uvAttributeDeclaration",U=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
attribute uv{X}: vec2f;
#endif
`;if(!q.IncludesShadersStoreWGSL[z])q.IncludesShadersStoreWGSL[z]=U;var V={name:z,shader:U};var B="bonesDeclaration",u=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[B])q.IncludesShadersStoreWGSL[B]=u;var x={name:B,shader:u};var H="bakedVertexAnimationDeclaration",L=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;if(!q.IncludesShadersStoreWGSL[H])q.IncludesShadersStoreWGSL[H]=L;var l={name:H,shader:L};var J="instancesDeclaration",j=`#ifdef INSTANCES
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[J])q.IncludesShadersStoreWGSL[J]=j;var c={name:J,shader:j};var K="prePassVertexDeclaration",g=`#ifdef PREPASS
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[K])q.IncludesShadersStoreWGSL[K]=g;var p={name:K,shader:g};var N="samplerVertexDeclaration",i=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying v_VARYINGNAME_UV: vec2f;
#endif
`;if(!q.IncludesShadersStoreWGSL[N])q.IncludesShadersStoreWGSL[N]=i;var m={name:N,shader:i};var O="bumpVertexDeclaration",d=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL) 
varying vTBN0: vec3f;varying vTBN1: vec3f;varying vTBN2: vec3f;
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[O])q.IncludesShadersStoreWGSL[O]=d;var h={name:O,shader:d};var Q="clipPlaneVertexDeclaration",S=`#ifdef CLIPPLANE
...
#endif
`;if(!q.IncludesShadersStoreWGSL[Q])q.IncludesShadersStoreWGSL[Q]=S;var o={name:Q,shader:S};var X="fogVertexDeclaration",t=`#ifdef FOG
varying vFogDistance: vec3f;
#endif
`;if(!q.IncludesShadersStoreWGSL[X])q.IncludesShadersStoreWGSL[X]=t;var n={name:X,shader:t};var Y="lightVxFragmentDeclaration",s=`#ifdef LIGHT{X}
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[Y])q.IncludesShadersStoreWGSL[Y]=s;var r={name:Y,shader:s};var Z="lightVxUboDeclaration",a=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[Z])q.IncludesShadersStoreWGSL[Z]=a;var e={name:Z,shader:a};var _="morphTargetsVertexGlobalDeclaration",qq=`#ifdef MORPHTARGETS
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[_])q.IncludesShadersStoreWGSL[_]=qq;var yq={name:_,shader:qq};var $="morphTargetsVertexDeclaration",zq=`#ifdef MORPHTARGETS
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[$])q.IncludesShadersStoreWGSL[$]=zq;var Bq={name:$,shader:zq};var w="vertexPullingDeclaration",Hq=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[w])q.IncludesShadersStoreWGSL[w]=Hq;var Jq={name:w,shader:Hq};var I="vertexPullingVertex",Kq=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[I])q.IncludesShadersStoreWGSL[I]=Kq;var Nq={name:I,shader:Kq};var k="morphTargetsVertexGlobal",Oq=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
var vertexID : f32;
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[k])q.IncludesShadersStoreWGSL[k]=Oq;var Qq={name:k,shader:Oq};var C="morphTargetsVertex",Xq=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[C])q.IncludesShadersStoreWGSL[C]=Xq;var Yq={name:C,shader:Xq};var A="instancesVertex",Zq=`#ifdef INSTANCES
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[A])q.IncludesShadersStoreWGSL[A]=Zq;var _q={name:A,shader:Zq};var F="bonesVertex",$q=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[F])q.IncludesShadersStoreWGSL[F]=$q;var wq={name:F,shader:$q};var f="bakedVertexAnimation",Iq=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;if(!q.IncludesShadersStoreWGSL[f])q.IncludesShadersStoreWGSL[f]=Iq;var kq={name:f,shader:Iq};var T="prePassVertex",Cq=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[T])q.IncludesShadersStoreWGSL[T]=Cq;var Aq={name:T,shader:Cq};var v="uvVariableDeclaration",Fq=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;if(!q.IncludesShadersStoreWGSL[v])q.IncludesShadersStoreWGSL[v]=Fq;var fq={name:v,shader:Fq};var P="samplerVertexImplementation",Tq=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[P])q.IncludesShadersStoreWGSL[P]=Tq;var vq={name:P,shader:Tq};var W="bumpVertex",Pq=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
var tbnNormal: vec3f=normalize(normalUpdated);var tbnTangent: vec3f=normalize(tangentUpdated.xyz);var tbnBitangent: vec3f=cross(tbnNormal,tbnTangent)*tangentUpdated.w;var matTemp= mat3x3f(finalWorld[0].xyz,finalWorld[1].xyz,finalWorld[2].xyz)* mat3x3f(tbnTangent,tbnBitangent,tbnNormal);vertexOutputs.vTBN0=matTemp[0];vertexOutputs.vTBN1=matTemp[1];vertexOutputs.vTBN2=matTemp[2];
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[W])q.IncludesShadersStoreWGSL[W]=Pq;var Wq={name:W,shader:Pq};var b="clipPlaneVertex",bq=`#ifdef CLIPPLANE
...
#endif
`;if(!q.IncludesShadersStoreWGSL[b])q.IncludesShadersStoreWGSL[b]=bq;var Gq={name:b,shader:bq};var G="fogVertex",Dq=`#ifdef FOG
#ifdef SCENE_UBO
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[G])q.IncludesShadersStoreWGSL[G]=Dq;var Eq={name:G,shader:Dq};var D="shadowsVertex",Rq=`#ifdef SHADOWS
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[D])q.IncludesShadersStoreWGSL[D]=Rq;var Mq={name:D,shader:Rq};var E="vertexColorMixing",Uq=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
...
#endif
#endif
`;if(!q.IncludesShadersStoreWGSL[E])q.IncludesShadersStoreWGSL[E]=Uq;var Vq={name:E,shader:Uq};var R="logDepthVertex",uq=`#ifdef LOGARITHMICDEPTH
vertexOutputs.vFragmentDepth=1.0+vertexOutputs.position.w;vertexOutputs.position.z=log2(max(0.000001,vertexOutputs.vFragmentDepth))*uniforms.logarithmicDepthConstant;
#endif
`;if(!q.IncludesShadersStoreWGSL[R])q.IncludesShadersStoreWGSL[R]=uq;var xq={name:R,shader:uq};var M="defaultVertexShader",iq=`#include<defaultUboDeclaration>
...
`;if(!q.ShadersStoreWGSL[M])q.ShadersStoreWGSL[M]=iq;var mq=[lq,jq,cq,V,Lq,x,l,c,p,gq,m,h,o,n,r,e,yq,Bq,pq,Jq,Nq,Qq,Yq,_q,wq,kq,Aq,fq,vq,Wq,Gq,Eq,Mq,Vq,xq];for(let y of mq)if(!q.IncludesShadersStoreWGSL[y.name])q.IncludesShadersStoreWGSL[y.name]=y.shader;var Rz={name:M,shader:iq};export{Rz as defaultVertexShaderWGSL};

//# debugId=9B95EC4E94E0B6E364756E2164756E21
//# sourceMappingURL=chunk-k6zr5aag.js.map
